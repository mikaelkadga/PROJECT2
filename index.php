		...
		<div class="fh5co-slider">
			<div class="container">
				<div class="owl-carousel owl-carousel-main">
				  <div><img src="images/gambar1.jpg" alt="Free HTML5 Website Template"></div>
				  <div><img src="images/gambar2.jpg" alt="Free HTML5 Website Template"></div>
				  <div><img src="images/gambar3.jpg" alt="Free HTML5 Website Template"></div>
				</div>
			</div>
		</div>
		<!-- Slider -->
			...
			<div class="container">
				<div class="row row-bottom-padded-md">
					<div class="col-md-8 col-md-offset-2 text-center ts-intro">
						...
						<br><a href="about.php">Read More</a>
					</div>
				</div>
