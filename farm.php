			...
			<div class="container">
				<div class="row row-bottom-padded-md">
					<div class="col-md-8 col-md-offset-2 text-center ts-intro">
						<h1>The Farmpreneur </h1>
						<p class="fh5co-lead">Farmpreneur is a residency program participant who aims to give birth to young food entrepreneurs from various corners of Indonesia.</p>
					</div>
				</div>
				...
				<div class="row row-bottom-padded-sm">
					<div class="col-md-4">
						<div class="fh5co-service text-center">
							<img src="images/farm1.png" class="zoom" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
					...
					<div class="col-md-4">
						<div class="fh5co-service text-center">
							<img src="images/farm2.png" class="zoom" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
							<h3>Project Title Here</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur ullam unde, totam harum laboriosam dolores.</p>
							<!--<p><a href="#" class="btn btn-primary btn-outline">View more</a></p>-->
						</div>
					...
					<div class="col-md-4">
						<div class="fh5co-service text-center">
							<img src="images/farm3.png" class="zoom" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
							<h3>Project Title Here</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur ullam unde, totam harum laboriosam dolores.</p>
							<!--<p><a href="#" class="btn btn-primary btn-outline">View more</a></p>-->
						</div>
